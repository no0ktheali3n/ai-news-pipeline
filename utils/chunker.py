...
# Purpose: Callable orchestrator module for triggering summarizer Lambdas in parallel
...
DEFAULT_LAMBDA_NAME = "ai-research-summarizer"  # Replace at runtime or via env
